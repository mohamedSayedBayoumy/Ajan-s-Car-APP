...
class _BMWState extends State<BMW> {
  ...
  Widget build(BuildContext context) {
    ...
    return
        FutureBuilder(
            future: FirebaseFirestore.instance.collection('BMW').get(),
                                      ...
                                      child: Row(
                                        children: [
                                          Padding(
                                              ...
                                              child:
                                              Container(
                                                width: MediaQuery.of(context).size.height*.148,
                                                height: MediaQuery.of(context).size.height*.150,
                                                decoration: BoxDecoration( color: Colors.black26, borderRadius: BorderRadius.circular(15)),
                                                child: null,
                                              )
                                          ),
                                          SizedBox(width: MediaQuery.of(context).size.width*.014,),
                                          Column(
                          ...
                          return GestureDetector(
                            onTap: (){
                              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>currentItem(
                                ...
                                descraption: snapshot.data.docs[index]['descraption'] ,
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                      ...
                                      child: Row(
                                        children: [
                                          Container(
                                            ...
                                            child: Hero(tag:snapshot.data.docs[index]['photo'] , child: Image.network(snapshot.data.docs[index]['photo']) ,),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  Container(child: Text(snapshot.data.docs[index]["Brand"], style: TextStyle(fontWeight: FontWeight.bold),)),
                                                ],
                                              ),
                                              Container(
                                                  ...
                                                  child: Text(
                                                    snapshot.data.docs[index]["descraption"],
                                                    maxLines: 5,
                                  ...
                                  Container(width: MediaQuery.of(context).size.width*.80 , height: MediaQuery.of(context).size.height*.0003 , color: Colors.grey.shade700,)
                                ],
                              ),
                            ),
                          ) ;
