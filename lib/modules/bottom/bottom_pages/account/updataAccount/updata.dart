...
class updata extends StatefulWidget {
  dynamic data;
  dynamic dox;
  updata({this.data, this.dox});

  @override
  State<updata> createState() => _updataState(data, dox);
}

class _updataState extends State<updata> {
  dynamic data;
  dynamic dox;
  _updataState(this.data, this.dox);

  @override
  Widget build(BuildContext context) {
    final bloc = BlocProvider.of<cubitBottom>(context);
    bloc.defaultt.text = data;
    return Scaffold(
        body: Center(
            child: Container(
